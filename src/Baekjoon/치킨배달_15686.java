...
//		System.out.println("cntTwo"+ cntTwo+" "+"r"+ m);
...
//	static void combination(int[] combArr, boolean[] visited, int start, int r) {
//		
//        if(r == 0) {
//            print(combArr, visited);
//            return;
//        } else {
//            for(int i = start; i < combArr.length; i++) {
//                visited[i] = true;
//                combination(combArr, visited, i + 1, r - 1);
//                visited[i] = false;
//            }
//        }
//    }
